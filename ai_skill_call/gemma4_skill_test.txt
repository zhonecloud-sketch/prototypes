...
class LMStudioClient:
    ...
    def chat_completion(
        ...
        # Explicitly pass enable_thinking True OR False to force the server's Jinja template behavior
        extra_body = {
...
class TestRunner:
    ...
    def _build_prompt(self, scenario: Dict) -> Tuple[str, str]:
        ...
        if self.thinking_mode:
            ...
            # Strict directive to prevent the model from triggering its native thinking process
            system_prompt += (
            ...
            for s_idx, scenario in enumerate(SCENARIOS, 1):
                ...
                for i in range(1, self.iterations + 1):
                    ...
                    try:
                        ...
                        # Pre-evaluation check: fail if thinking tags are present when disabled
